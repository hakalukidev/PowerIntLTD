...
function buildPermissionCatalog(): Record<string, PermissionDefinition> {
  const groups: Array<[string, ModuleActionConfig]> = [
    ...
    ['damage_products', { category: 'Inventory Management', noun: 'damage product records' }],
  ...
  return {
    ...
    users: {
      u_admin: {
        ...
        name: 'Robin',
        loginId: 'robin',
        email: 'robin@powerinternationalbd.com',
        phone: '01844902338',
        roleId: 'admin',
      ...
      u_store: {
        ...
        name: 'Farzana Akter',
        loginId: 'farzana',
        email: 'farzana@powerinternationalbd.com',
        phone: '+8801700000002',
      ...
      u_sales: {
        ...
        name: 'Sabbir Ahmed',
        loginId: 'sabbir',
        email: 'sabbir@powerinternationalbd.com',
        phone: '+8801700000003',
        roleId: 'sales_person',
      ...
      u_accounts: {
        ...
        name: 'Nabila Islam',
        loginId: 'nabila',
        email: 'nabila@powerinternationalbd.com',
        phone: '+8801700000004',
        roleId: 'accountant',
      ...
      u_viewer: {
        ...
        name: 'Jitu Roy',
        loginId: 'jitu',
        email: 'jitu@powerinternationalbd.com',
        phone: '+8801700000005',
        roleId: 'viewer',
    ...
    damageProducts: {
      dmg_1001: {
        id: 'dmg_1001',
        productName: 'Two Post Service Lift',
        quantity: 1,
        zone: 'Chattogram',
        reportedDate: shiftDays(-6),
        sentDate: shiftDays(-4),
        reason: 'Hydraulic cylinder leak found during unboxing.',
        notes: 'Waiting for main office inspection.',
        status: 'sent-to-office',
        createdAt: shiftDays(-6),
        updatedAt: shiftDays(-4),
      },
      dmg_1002: {
        id: 'dmg_1002',
        productName: 'Classic Polo (carton)',
        quantity: 8,
        zone: 'Dhaka',
        reportedDate: shiftDays(-2),
